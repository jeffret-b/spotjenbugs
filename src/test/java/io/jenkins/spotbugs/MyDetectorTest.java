...
public class MyDetectorTest {
    ...
    public void testGoodCase() {
        Path path = Paths.get("target/test-classes", "io.jenkins.spotbugs".replace('.', '/'), "GoodCase.class");
    ...
    public void testBadCase() {
        Path path = Paths.get("target/test-classes", "io.jenkins.spotbugs".replace('.', '/'), "BadCase.class");
        BugCollection bugCollection = spotbugs.performAnalysis(path);
